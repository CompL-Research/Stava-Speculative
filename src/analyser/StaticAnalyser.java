...
//		if(body.getMethod().getBytecodeSignature().toString().compareTo("<cck.text.StringUtil: <clinit>()V>") == 0 ){
//			//System.out.println("Skipping this method");
//			return;
//		}
	...
	public void apply(SootMethod m, Unit u, PointsToGraph ptg, Map<ObjectNode, EscapeStatus> summary) {
		...
		if (u instanceof JAssignStmt) {
			...
			MonitorStmtHandler.handle(u, ptg, summary);
				...
				u instanceof JTableSwitchStmt || u instanceof JLookupSwitchStmt || u instanceof NopStmt) {
		} else {
